...
let ContatoBuscaComponent = class ContatoBuscaComponent {
    ...
    ngOnInit() {
        this.contatos = this.termosDaBusca
            .debounceTime(500) // aguarde por 500s para emitir novos eventos
            .distinctUntilChanged() //verifica a ultima busca ignore se o proximo termo de busca for igual ao anterior
    ...
    verDetalhe(contato) {
        ...
        this.buscaChange.emit(''); //reseta o campo de busca
    }
};
__decorate([
    core_1.Input(),
